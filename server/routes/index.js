...
router.get('/categories', controllers.category.get)
router.get('/categories/:id', controllers.category.get)
router.post('/categories', controllers.category.post)
router.patch('/categories', controllers.category.patch)
router.delete('/categories/:id', controllers.category.del)
